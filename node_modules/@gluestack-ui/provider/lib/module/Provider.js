...
export const GluestackUIContext = /*#__PURE__*/React.createContext({});
export const GluestackUIContextProvider = _ref => {
  let {
    children,
    components,
    ...props
  ...
  return /*#__PURE__*/React.createElement(GluestackUIContext.Provider, _extends({
    value: components
  }, props), children);
};
export const Provider = _ref2 => {
  ...
  return _ref3 => {
    ...
    return /*#__PURE__*/React.createElement(GluestackUIContextProvider, {
