...
export interface GSConfig extends Omit<CreateGenericConfig, keyof ICustomConfig>, ICustomConfig {
}
...
export type GlueStackConfig<IToken extends Tokens, IGlobalAliases, IGlobalStyle> = {
    tokens: IToken;
    aliases: IGlobalAliases;
    globalStyle?: GlobalStyles<IGlobalAliases, IToken, IGlobalStyle>;
};
export type InferConfig<Conf> = Conf extends GlueStackConfig<infer A, infer C, infer D> ? GlueStackConfig<A, C, D> : any;
export type CreateGenericConfig = GlueStackConfig<Tokens, GenericAliases, GenericGlobalStyle>;
...
export type VariantType<Variants, GenericComponentStyles> = {
    [Key1 in keyof Variants]: {
        [Key in keyof Variants[Key1] | (string & {})]?: Partial<SxProps<GenericComponentStyles>>;
    };
} | {
    [Key: string & {}]: any;
};
...
export type ComponentProps<GenericComponentStyles, Variants, P> = SxStyleProps<GenericComponentStyles, Variants> & {
    states?: {
        [K in IState]?: boolean;
    };
} & (GSConfig['globalStyle'] extends object ? {
    [Key in keyof MergeNested<GlobalVariants, Variants>]?: keyof MergeNested<GlobalVariants, Variants>[Key];
...
export type STATES = 'indeterminate' | 'checked' | 'readOnly' | 'required' | 'invalid' | 'focus' | 'focusVisible' | 'hover' | 'pressed' | 'active' | 'loading' | 'disabled';
...
export type ITheme<Variants, P> = Partial<StyledThemeProps<Variants & GlobalVariants, P['style']>>;
export type VariantTypeNew<Variants, GenericComponentStyles, GenericComponentProps> = {
    [Key1 in keyof Variants]: {
        [Key in keyof Variants[Key1] | (string & {})]: Partial<SxPropsNew<GenericComponentStyles, Variants> & {
            [K in `@${IMediaQueries}`]?: SxPropsNew<GenericComponentStyles, Variants, GenericComponentProps>;
        }>;
    };
};
...
export type StyledThemePropsNew<Variants, GenericComponentStyles, GenericComponentProps> = SxPropsNew<GenericComponentStyles, Variants & GlobalVariants, GenericComponentProps> & {
    [Key in `@${IMediaQueries}`]: SxPropsNew<GenericComponentStyles, Variants, GenericComponentProps>;
} & {
    variants: VariantTypeNew<Variants, GenericComponentStyles, GenericComponentProps>;
    compoundVariants?: Array<CompoundVariant<Variants, GenericComponentStyles, GenericComponentProps>>;
    defaultProps?: {
        [Key in keyof MergeNested<VariantTypeNew<Variants, GenericComponentStyles, GenericComponentProps>, GlobalVariants>]?: keyof MergeNested<VariantTypeNew<Variants, GenericComponentStyles, GenericComponentProps>, GlobalVariants>[Key];
    } & {
        [key: string]: any;
    };
};
export type IThemeNew<Variants, P> = Partial<StyledThemePropsNew<Variants, P['style'], P>>;
...
export type SxPropsNew<GenericComponentStyles = AliasesProps, Variants = unknown, GenericComponentProps = unknown, PLATFORM = ''> = Partial<StylePropsType<GenericComponentStyles, PLATFORM> | {
    ...
    [Key in `_${COLORMODES}`]?: SxPropsNew<GenericComponentStyles, Variants, GenericComponentProps, PLATFORM>;
} & {
    [Key in `:${IState}`]?: SxPropsNew<GenericComponentStyles, Variants, GenericComponentProps, PLATFORM>;
} & {
    [Key in `_${PLATFORMS}`]?: SxPropsNew<GenericComponentStyles, Variants, GenericComponentProps, Key>;
} & {
    [Key in `_${string}`]?: SxPropsNew<RNStyledProps, Variants, GenericComponentProps, PLATFORM> & {
        props?: RNProps & RNStyledProps & {
            as?: any;
        } & Partial<{
            [key: string]: any;
        }>;
