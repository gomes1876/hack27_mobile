...
const setObjectKeyValue = (obj, keys, value) => {
  ...
  let current = obj;
  (_keys = keys) === null || _keys === void 0 ? void 0 : _keys.forEach((key, index) => {
    var _keys2;
...
const resolveResponsiveProps = (sxVerbosed, breakpoint, path, prop, responsiveStyle) => {
  ...
  if (sxVerbosed.queries) {
    ...
    const existingBeakpointIndex = sxVerbosed === null || sxVerbosed === void 0 ? void 0 : (_sxVerbosed$queries = sxVerbosed.queries) === null || _sxVerbosed$queries === void 0 ? void 0 : _sxVerbosed$queries.findIndex(data => data.condition === breakpoint);
    if (existingBeakpointIndex !== -1) {
      ...
      sxVerbosed === null || sxVerbosed === void 0 ? void 0 : (_sxVerbosed$queries2 = sxVerbosed.queries) === null || _sxVerbosed$queries2 === void 0 ? void 0 : _sxVerbosed$queries2.push({
    ...
    sxVerbosed.queries = [];
    sxVerbosed === null || sxVerbosed === void 0 ? void 0 : (_sxVerbosed$queries3 = sxVerbosed.queries) === null || _sxVerbosed$queries3 === void 0 ? void 0 : _sxVerbosed$queries3.push({
      condition: breakpoint,
      value: sxResolvedResponsiveProp
    });
  }
...
export function resolveStyledPropsRecursively() {
  ...
  themeKeys === null || themeKeys === void 0 ? void 0 : themeKeys.forEach(prop => {
...
function resolveVariantSize(theme) {
  ...
  themeKey === null || themeKey === void 0 ? void 0 : themeKey.map(prop => {
