...
function isValidBreakpoint(config, queryCondition) {
  var _Dimensions$get;
  const windowWidth = (_Dimensions$get = Dimensions.get('window')) === null || _Dimensions$get === void 0 ? void 0 : _Dimensions$get.width;
...
export function generateStylePropsFromCSSIds(props, styleCSSIds, globalStyleMap, config) {
