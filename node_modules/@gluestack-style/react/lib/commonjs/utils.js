...
exports.deepMergeArray = exports.deepMerge = exports.convertRemToAbsolute = exports.convertAbsoluteToRem = exports.convertAbsoluteToPx = exports.BASE_FONT_SIZE = void 0;
    ...
    if (splitCurrentToken.length > 1) {
      ...
      if (tokenScaleMap[propName]) {
        ...
        if (config !== null && config !== void 0 && config.tokens[modifiedTokenScale] && config !== null && config !== void 0 && config.tokens[modifiedTokenScale].hasOwnProperty(splitCurrentToken[0])) {
          var _config$tokens, _config$tokens$modifi;
          const tokenValue = config === null || config === void 0 ? void 0 : (_config$tokens = config.tokens) === null || _config$tokens === void 0 ? void 0 : (_config$tokens$modifi = _config$tokens[modifiedTokenScale]) === null || _config$tokens$modifi === void 0 ? void 0 : _config$tokens$modifi[splitCurrentToken[0]];
          typeofResult = typeof tokenValue;
...
const platformSpecificSpaceUnits = (theme, platform) => {
  ...
  scales.forEach(key => {
    ...
    //@ts-ignore
    const scale = (theme === null || theme === void 0 ? void 0 : (_theme$tokens = theme.tokens) === null || _theme$tokens === void 0 ? void 0 : _theme$tokens[key]) ?? {};
    const newScale = {
      ...scale
    };
