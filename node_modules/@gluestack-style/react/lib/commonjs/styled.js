...
function convertUtiltiyToSXFromProps(componentProps, componentExtendedConfig, componentStyleConfig) {
  ...
  } = (0, _convertUtilityToSx.convertUtilityPropsToSX)(componentExtendedConfig, componentStyleConfig === null || componentStyleConfig === void 0 ? void 0 : componentStyleConfig.descendantStyle, componentRestProps);
...
function getMergedDefaultCSSIdsAndProps(componentStyleIds, incomingVariantProps, theme, properties) {
  ...
  if (componentStyleIds && componentStyleIds !== null && componentStyleIds !== void 0 && componentStyleIds.baseStyle && componentStyleIds !== null && componentStyleIds !== void 0 && (_componentStyleIds$ba = componentStyleIds.baseStyle) !== null && _componentStyleIds$ba !== void 0 && _componentStyleIds$ba.ids) {
    ...
    props = (0, _utils.deepMergeObjects)(props, componentStyleIds === null || componentStyleIds === void 0 ? void 0 : (_componentStyleIds$ba3 = componentStyleIds.baseStyle) === null || _componentStyleIds$ba3 === void 0 ? void 0 : _componentStyleIds$ba3.props);
  }
...
function verboseStyled(Component, theme) {
  ...
  function injectComponentAndDescendantStyles(orderedResolved, styleTagId) {
    ...
    const componentOrderResolvedBaseStyle = (0, _resolver.getComponentResolvedBaseStyle)(orderedResolved);
    const componentOrderResolvedVariantStyle = (0, _resolver.getComponentResolvedVariantStyle)(orderedResolved);
    const descendantOrderResolvedBaseStyle = (0, _resolver.getDescendantResolvedBaseStyle)(orderedResolved);
    const descendantOrderResolvedVariantStyle = (0, _resolver.getDescendantResolvedVariantStyle)(orderedResolved);
    (0, _injectInStyle.injectInStyle)(globalStyleMap, componentOrderResolvedBaseStyle, type + '-base', styleTagId ? styleTagId : 'css-injected-boot-time');
    (0, _injectInStyle.injectInStyle)(globalStyleMap, descendantOrderResolvedBaseStyle, type + '-descendant-base', styleTagId ? styleTagId : 'css-injected-boot-time-descendant');
    (0, _injectInStyle.injectInStyle)(globalStyleMap, componentOrderResolvedVariantStyle, type + '-variant', styleTagId ? styleTagId : 'css-injected-boot-time');
    (0, _injectInStyle.injectInStyle)(globalStyleMap, descendantOrderResolvedVariantStyle, type + '-descendant-variant', styleTagId ? styleTagId : 'css-injected-boot-time-descendant');
  }
  ...
  function injectSx(sx) {
    ...
    const sxStyledResolved = (0, _resolver.styledToStyledResolved)(
    // @ts-ignore
    inlineSxTheme, [], componentExtendedConfig);
    const sxHash = (0, _stableHash.stableHash)(sx);
    const orderedSXResolved = (0, _resolver.styledResolvedToOrderedSXResolved)(sxStyledResolved);
  ...
  const NewComp = (_ref, ref) => {
    ...
    if (globalStyle) {
      resolvePlatformTheme(globalStyle, _reactNative.Platform.OS);
      theme = {
        ...theme,
        baseStyle: {
    ...
    const [COLOR_MODE, setCOLOR_MODE] = (0, _react.useState)((0, _colorMode.get)());
    (0, _react.useEffect)(() => {
    ...
    if (!styleHashCreated) {
      const themeHash = (BUILD_TIME_PARAMS === null || BUILD_TIME_PARAMS === void 0 ? void 0 : BUILD_TIME_PARAMS.themeHash) || (0, _stableHash.stableHash)({
        ...theme,
      ...
      if (!orderedResolved) {
        const styledResolved = (0, _resolver.styledToStyledResolved)(theme, [], componentExtendedConfig);
        orderedResolved = (0, _resolver.styledResolvedToOrderedSXResolved)(styledResolved);
        (0, _updateCSSStyleInOrderedResolved.INTERNAL_updateCSSStyleInOrderedResolved)(orderedResolved, themeHash);
      }
      if (Object.keys(styleIds).length === 0) {
        styleIds = (0, _resolver.getStyleIds)(orderedResolved, componentStyleConfig);
      }
    ...
    const incomingComponentProps = (0, _react.useMemo)(() => {
      return {
    ...
    const [applySxStateBaseStyleCSSIds, setApplyStateSxBaseStyleCSSIds] = (0, _react.useState)([]);
    const [applySxStateVariantStyleCSSIds, setApplyStateSxVariantStyleCSSIds] = (0, _react.useState)([]);
    const [applySxDescendantStateStyleCSSIdsAndPropsWithKey, setApplySxDescendantStateStyleCSSIdsAndPropsWithKey] = (0, _react.useState)({});
    const [componentStatePassingProps, setComponentStatePassingProps] = (0, _react.useState)({});
    const [sxStatePassingProps, setSxStatePassingProps] = (0, _react.useState)({});
    const {
    ...
    const passingProps = _react.default.useMemo(() => {
      return (0, _utils.deepMergeObjects)(applyComponentPassingProps, componentStatePassingProps, sxComponentPassingProps.current, sxStatePassingProps);
      ...
      componentStyleConfig.resolveProps.forEach(toBeResovledProp => {
        if (utilityAndPassingProps[toBeResovledProp]) {
          ...
          if (CONFIG.propertyResolver && CONFIG.propertyResolver.props && CONFIG.propertyResolver.props[toBeResovledProp]) {
            ...
            //@ts-ignore
            resolvedInlineProps[toBeResovledProp] = (0, _utils.getResolvedTokenValueFromConfig)(componentExtendedConfig, utilityAndPassingProps, toBeResovledProp, utilityAndPassingProps[toBeResovledProp]);
          }
    ...
    const [applyComponentStateBaseStyleIds, setApplyComponentStateBaseStyleIds] = (0, _react.useState)([]);
    const [applyComponentStateVariantStyleIds, setApplyComponentStateVariantStyleIds] = (0, _react.useState)([]);
    const applyDescendantsStyleCSSIdsAndPropsWithKey = _react.default.useMemo(() => {
    ...
    const [applyDescendantStateStyleCSSIdsAndPropsWithKey, setApplyDescendantStateStyleCSSIdsAndPropsWithKey] = (0, _react.useState)({});
    ...
    if (Object.keys(filteredComponentSx).length > 0 || Object.keys(filteredPassingSx).length > 0) {
      ...
      const sxStyleIds = (0, _resolver.getStyleIds)(orderedSXResolved, componentStyleConfig);
    ...
    const descendantCSSIds = _react.default.useMemo(() => {
    ...
    if (_reactNative.Platform.OS !== 'web') {
      ...
      dimensions = (0, _reactNative.useWindowDimensions)();
    }
    const resolvedStyleProps = (0, _generateStylePropsFromCSSIds.generateStylePropsFromCSSIds)(utilityAndPassingProps, styleCSSIds, globalStyleMap, CONFIG
    // currentWidth
    );

    // Prepare to be applied style based on specificity
    const finalStyleBasedOnSpecificity = (0, _react.useMemo)(() => {
      let tempStyle = [];
      ...
      return _reactNative.StyleSheet.flatten(tempStyle);
    ...
    const component = !AsComp ? /*#__PURE__*/_react.default.createElement(Component, finalComponentProps, children) : /*#__PURE__*/_react.default.createElement(AsComp, finalComponentProps, children);
  ...
  const StyledComp = /*#__PURE__*/_react.default.forwardRef(NewComp);
