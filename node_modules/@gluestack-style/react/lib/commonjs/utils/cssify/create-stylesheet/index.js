...
const createStyleSheet = function (stylesObject) {
  ...
  let prefixColorMode = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'gs-';
  ...
  Object.keys(stylesObject).map(key => {
    ...
    const rule = (0, _common.createCssRule)(mediaQuery, colorSchemeQuery, finalColorMode, dataHash, css, 'style', prefixClassName, prefixColorMode);
